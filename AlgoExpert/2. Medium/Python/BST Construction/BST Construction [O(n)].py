    ...
    def remove(self, value, parent_node=None):
        ...
        while True:
            ...
            if comparision == -1:
                ...
                if node.left and node.right:                      				node.value = get_min_node_value(node.right)
                ...
                elif parent_node.left == node:                      parent_node.left = node.left if node.left else node.right
                elif parent_node.right == node:                      parent_node.right = node.left if node.left else node.right
                break
